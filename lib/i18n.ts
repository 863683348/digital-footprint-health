...
const zh: Record<string, string> = {
  ...
  'theme.toggle.light': '切换到浅色',
  'theme.toggle.dark': '切换到深色',
  ...
  'pay.success': '支付成功，开始删除',
  'pay.failed': '支付失败：{reason}',
  'pay.canceled': '支付已取消',
  'pay.notSignedIn': '请先登录后再支付',
  'pay.paypalNotConfigured': '支付服务未配置，请联系管理员',
  'pay.refund.title': '退款',
  'pay.refund.eligible': '此订单可申请退款',
  'pay.refund.full': '全额退款（删除未开始）',
  'pay.refund.partial': '按比例退款（已删除 {deleted}/{total} 条）',
  ...
  // payment (Waffo)
  'pay.button': '使用 Waffo 支付',
  'pay.waffo': 'Waffo',
  'pay.waffoNotConfigured': '支付服务未配置，请联系管理员',
  'pay.confirming': '支付确认中…',
  'pay.confirmTimeout': '支付确认超时，请稍后查看订单状态',
  'pay.payFailedStatus': '支付未成功，请重试',

  // account
  'account.title': '个人中心',
  'account.notSignedIn': '请先登录',
  'account.notSignedIn.desc': '登录后即可查看会员信息与订单记录',
  'account.goSignIn': '去登录',
  'account.section.profile': '账户信息',
  'account.profile.name': '昵称',
  'account.profile.email': '邮箱',
  'account.profile.loginMethod': '登录方式',
  'account.profile.joined': '加入时间',
  'account.section.member': '会员信息',
  'account.member.status': '会员状态',
  'account.member.active': '已激活',
  'account.member.since': '会员起始日',
  'account.member.quota': '包含额度',
  'account.member.quota.monthly': '每月 2000 条删除额度',
  'account.member.quota.annual': '每年 24000 条删除额度',
  'account.member.spent': '累计消费',
  'account.member.upgrade': '使用删除额度',
  'account.member.renew': '续费 / 升级',
  'account.member.none': '你还没有会员，升级后可享批量删除额度',
  'account.section.orders': '我的订单',
  'account.orders.empty': '暂无订单记录',
  'account.orders.id': '订单号',
  'account.orders.plan': '套餐',
  'account.orders.amount': '金额',
  'account.orders.status': '状态',
  'account.orders.date': '日期',
  'account.section.settings': '设置',
  'account.settings.lang': '语言',
  'account.settings.bindX': '绑定 X 账号',
  'account.settings.comingSoon': '即将上线',
  'account.settings.signout': '退出登录',
...
const en: Record<string, string> = {
  ...
  'pay.dryrun.free': 'Dry run is free — no payment needed',
  'pay.paypal': 'PayPal',
  ...
  'pay.success': 'Payment successful, starting deletion',
  'pay.failed': 'Payment failed: {reason}',
  'pay.canceled': 'Payment canceled',
  'pay.notSignedIn': 'Please sign in before paying',
  'pay.paypalNotConfigured': 'Payment service not configured. Contact the admin.',
  'pay.refund.title': 'Refund',
  'pay.refund.eligible': 'This order is eligible for a refund',
  'pay.refund.full': 'Full refund (deletion not started)',
  'pay.refund.partial': 'Prorated refund ({deleted}/{total} tweets already deleted)',
  ...
  // payment (Waffo)
  'pay.button': 'Pay with Waffo',
  'pay.waffo': 'Waffo',
  'pay.waffoNotConfigured': 'Payment service is not configured. Contact the admin.',
  'pay.confirming': 'Confirming payment…',
  'pay.confirmTimeout': 'Payment confirmation timed out. Check your order status later.',
  'pay.payFailedStatus': 'Payment failed. Please try again.',

  // account
  'account.title': 'Account',
  'account.notSignedIn': 'Please sign in first',
  'account.notSignedIn.desc': 'Sign in to view membership info and order history',
  'account.goSignIn': 'Sign in',
  'account.section.profile': 'Account info',
  'account.profile.name': 'Name',
  'account.profile.email': 'Email',
  'account.profile.loginMethod': 'Signed in with',
  'account.profile.joined': 'Joined',
  'account.section.member': 'Membership',
  'account.member.status': 'Status',
  'account.member.active': 'Active',
  'account.member.since': 'Member since',
  'account.member.quota': 'Included quota',
  'account.member.quota.monthly': '2,000 deletions per month',
  'account.member.quota.annual': '24,000 deletions per year',
  'account.member.spent': 'Total spent',
  'account.member.upgrade': 'Use deletion quota',
  'account.member.renew': 'Renew / upgrade',
  'account.member.none': 'You have no membership yet. Upgrade for batch deletion quota.',
  ...
  'account.section.settings': 'Settings',
  'account.settings.lang': 'Language',
  'account.settings.bindX': 'Connect X account',
  'account.settings.comingSoon': 'Coming soon',
