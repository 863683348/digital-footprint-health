  ...
  return (
    <header className="border-b border-line bg-surface">
      <div className="max-w-[1040px] mx-auto px-4 h-14 flex items-center justify-between">
        <LangLink href="/" className="flex items-center gap-2 min-w-0">
        ...
        <nav className="flex items-center gap-3 sm:gap-5 text-t-7 sm:text-t-6 text-ink-soft">
          <LangLink href="/" className="hover:text-ink transition-calm">
            {t('nav.home')}
          </LangLink>
          <LangLink href="/upload" className="hover:text-ink transition-calm">
            {t('nav.upload')}
          </LangLink>
