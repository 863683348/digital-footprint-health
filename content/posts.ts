...
<p>digital-footprint-health.shop 是 X 数字足迹体检工具：上传归档，本机逐条解析，扫手机号、住址、定位与敏感话题，给 0-100 健康评分。体检免费只读、不上传数据。清理时删除按条计费，可 <a href="/pricing">暂停、续传、退款</a>。</p>`,
  ...
  { slug: "delete-10000-tweets-real-cost", title: { zh: "一次删除上万条的真实成本与耗时", en: "The Real Cost of Deleting 10,000+ Tweets" }, date: "2026-08-23", category: "cleanup", excerpt: { zh: "批量删除一万条推文需要多少时间和金钱？", en: "How much time and money does bulk-deleting 10,000 tweets cost?" }, tags: ["bulk deletion"], content: { en: "Deleting 10,000 tweets takes roughly 10 hours. X rate limits cap you at ~1,000 tweets/hour." } },
  { slug: "delete-vs-protect-safety", title: { zh: "删除 vs 锁号：哪个才是安全", en: "Delete vs Protect: What Actually Keeps You Safe" }, date: "2026-08-23", category: "privacy", excerpt: { zh: "删除推文和锁定账号，哪个更能保护你的数字足迹？", en: "Deleting tweets vs locking your account — which protects your digital footprint?" }, tags: ["privacy"], content: { en: "Delete removes permanently. Lock makes account private. Delete harmful tweets, lock to reduce exposure." } },
  { slug: "tweets-js-anatomy", title: { zh: "tweets.js 结构全解析", en: "tweets.js Fully Decoded: Anatomy of One Tweet" }, date: "2026-08-23", category: "technical", excerpt: { zh: "tweets.js 归档文件里每条推文的数据结构", en: "What does the data structure of a single tweet look like inside tweets.js?" }, tags: ["tweets.js", "JSON"], content: { en: "tweets.js contains every tweet you posted. Core fields: created_at, full_text, id_str, favorite_count, retweet_count, entities." } },
];
